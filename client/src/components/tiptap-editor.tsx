...
export default function TipTapEditor({ value, onChange }: TipTapEditorProps) {
  ...
  return (
    <div className="h-full flex flex-col bg-white rounded-lg w-full tiptap-container">
      <div className="flex flex-row items-center gap-1 p-2 border-b bg-white w-full"> {/* Added flex-row */}
        <div className="flex flex-row items-center gap-1"> {/* Added flex-row */}
          <Button
            type="button"
            variant="ghost"
            size="sm"
